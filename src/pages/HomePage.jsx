    ...
    <div style={{
      ...
      <section style={{ 
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '1.2rem', color: '#888', lineHeight: 1.6, marginBottom: '3rem' }}>
      ...
      {/* LOGOS MARQUEE */}
      <section style={{ padding: '3rem 1.5rem', borderTop: '1px solid rgba(255,255,255,0.05)', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', overflow: 'hidden', background: 'rgba(255,255,255,0.01)' }}>
      ...
      <section style={{ padding: '8rem 1.5rem', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <p style={{ color: '#888', fontSize: '1.1rem', textAlign: 'center', marginBottom: '4rem' }}>Engineered for scale, built for performance.</p>
        
        <div className="bento-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1.5rem' }}>
          
          {/* Main Large Card */}
          <div className="bento-card" onClick={() => navigate('/services/ai-automation')} style={{ gridColumn: '1 / -1', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: '300px' }}>
            <div style={{ maxWidth: '600px' }}>
              <div style={{ background: 'rgba(255,255,255,0.1)', width: '48px', height: '48px', borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
                <Cpu size={24} color="#FFF" />
              </div>
              <h3 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: '1rem', letterSpacing: '-0.5px' }}>AI Automation & Agents</h3>
              <p style={{ color: '#A0A0A0', fontSize: '1.1rem', lineHeight: 1.6, marginBottom: '2rem' }}>
          ...
          {/* Half Card 1 */}
          <div className="bento-card" onClick={() => navigate('/services/web-development')} style={{ minHeight: '280px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              ...
              <p style={{ color: '#A0A0A0', fontSize: '1rem', lineHeight: 1.5 }}>
          ...
          {/* Half Card 2 */}
          <div className="bento-card" onClick={() => navigate('/services')} style={{ minHeight: '280px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
              <div style={{ background: 'rgba(255,255,255,0.1)', width: '40px', height: '40px', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem' }}>
      ...
      {/* THE PROCESS */}
      <section style={{ padding: '6rem 1.5rem', background: 'rgba(255,255,255,0.02)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '3rem' }}>
            {[
              ...
              <div key={idx} style={{ position: 'relative' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '20px', background: '#FFF', color: '#000', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: '1.2rem', marginBottom: '1.5rem' }}>
                  {idx + 1}
                </div>
                <h4 style={{ fontSize: '1.2rem', fontWeight: 700, marginBottom: '0.8rem' }}>{step.title}</h4>
                <p style={{ color: '#A0A0A0', lineHeight: 1.6 }}>{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
