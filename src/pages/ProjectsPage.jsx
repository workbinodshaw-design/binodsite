...
const ProjectsPage = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'A complete full-stack astrology and numerology consulting platform. Features a powerful custom backend for managing secure bookings, user data, and an elegant online presence.',
      tags: ['Full-Stack', 'Backend API', 'UI/UX'],
