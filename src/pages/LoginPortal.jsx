      ...
      if (user) {
        try {
          ...
          if (userDoc.exists() && userDoc.data().role === 'employee') {
            ...
            navigate('/admin'); // Default to admin for founders
          }
        } catch (e) {
          navigate('/admin');
        }
  ...
  return (
    <div className="page-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '80vh', paddingTop: '8rem' }}>
      <div className="glass text-center" style={{ padding: '4rem', borderRadius: '24px', maxWidth: '400px', width: '100%' }}>
        ...
        <h2 style={{ marginBottom: '0.5rem' }}>Team Portal</h2>
        <p style={{ color: '#aaa', marginBottom: '2rem' }}>Sign in to access your dashboard</p>
