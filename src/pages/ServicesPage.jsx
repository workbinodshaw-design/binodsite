    ...
    <>
      ...
      <div className="service-detail-section" style={{ display: 'flex', flexDirection: 'column', gap: '3rem', marginBottom: '8rem' }}>
        <div className="service-header-row" style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '2rem' }}>
          ...
          <div>
            <h2 style={{ margin: 0, fontSize: 'clamp(1.5rem, 5vw, 2.2rem)' }}>AI & Automation</h2>
            <p className="text-secondary" style={{ margin: '0.5rem 0 0 0', fontSize: 'clamp(0.9rem, 2.5vw, 1rem)' }}>Fire your manual tasks. Hire code.</p>
          </div>
        </div>
        ...
        <div className="service-grid-2-col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'start' }}>
          ...
          <div className="service-detail-content">
            <h3 style={{ fontSize: 'clamp(1.2rem, 4vw, 1.6rem)', marginBottom: '1.5rem', color: 'var(--text-primary)' }}>Stop wasting time on tasks a robot can do.</h3>
            
            <p className="text-secondary" style={{ fontSize: 'clamp(0.9rem, 2.5vw, 1rem)', lineHeight: '1.8', marginBottom: '1.5rem' }}>
            ...
            <p className="text-secondary" style={{ fontSize: 'clamp(0.9rem, 2.5vw, 1rem)', lineHeight: '1.8', marginBottom: '2.5rem' }}>
            ...
            <div className="service-features-list" style={{ marginTop: '2rem' }}>
              <div className="feature-item" style={{ alignItems: 'flex-start', marginBottom: '1.5rem' }}>
                ...
                <div>
                  <strong style={{ fontSize: 'clamp(0.95rem, 3vw, 1.1rem)', marginBottom: '0.5rem', display: 'block' }}>Customer Support AI Agents</strong>
              ...
              <div className="feature-item" style={{ alignItems: 'flex-start', marginBottom: '1.5rem' }}>
                ...
                <div>
                  <strong style={{ fontSize: 'clamp(0.95rem, 3vw, 1.1rem)', marginBottom: '0.5rem', display: 'block' }}>Complete Workflow Automation</strong>
            ...
            <Link to="/services/ai-automation" className="btn btn-primary" style={{ marginTop: '1.5rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', textDecoration: 'none', background: '#5D3FD3', padding: '1rem 2rem', fontSize: 'clamp(0.9rem, 2.5vw, 1rem)' }}>
      ...
      <div className="service-detail-section" style={{ display: 'flex', flexDirection: 'column', gap: '3rem', marginBottom: '8rem' }}>
        <div className="service-header-row" style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '2rem' }}>
          ...
          <div>
            <h2 style={{ margin: 0, fontSize: 'clamp(1.5rem, 5vw, 2.2rem)' }}>High-End Web Design & Development</h2>
            <p className="text-secondary" style={{ margin: '0.5rem 0 0 0', fontSize: 'clamp(0.9rem, 2.5vw, 1rem)' }}>We don't build brochures. We build digital salespeople.</p>
          </div>
        </div>
        ...
        <div className="service-grid-2-col" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'start' }}>
          ...
          {/* Content Side */}
          <div className="service-detail-content">
            <h3 style={{ fontSize: 'clamp(1.2rem, 4vw, 1.6rem)', marginBottom: '1.5rem', color: 'var(--text-primary)' }}>Your website is your ultimate first impression.</h3>
            ...
            <div className="service-features-list" style={{ marginTop: '2rem' }}>
              <div className="feature-item" style={{ alignItems: 'flex-start', marginBottom: '1.5rem' }}>
                ...
                <div>
                  <strong style={{ fontSize: 'clamp(0.95rem, 3vw, 1.1rem)', marginBottom: '0.5rem', display: 'block' }}>Conversion-Optimized Landing Pages</strong>
              ...
              <div className="feature-item" style={{ alignItems: 'flex-start', marginBottom: '1.5rem' }}>
                ...
                <div>
                  <strong style={{ fontSize: 'clamp(0.95rem, 3vw, 1.1rem)', marginBottom: '0.5rem', display: 'block' }}>SaaS & Complex Architectures</strong>
            ...
            <Link to="/services/web-development" className="btn btn-primary" style={{ marginTop: '1.5rem', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', textDecoration: 'none', padding: '1rem 2rem', fontSize: 'clamp(0.9rem, 2.5vw, 1rem)' }}>
