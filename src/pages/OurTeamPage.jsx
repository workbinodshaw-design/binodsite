      ...
      <div className="container">
        ...
        {(!searchQuery || 'binod shaw founder ceo'.includes(searchQuery.toLowerCase())) && (
          <div style={{ marginBottom: '80px' }}>
            <h2 style={{ fontSize: '2rem', marginBottom: '30px', textAlign: 'center', fontFamily: 'Syne, sans-serif' }}>Leadership</h2>
        ...
        {/* Employees Section */}
        <div>
          <h2 style={{ fontSize: '2rem', marginBottom: '30px', textAlign: 'center', fontFamily: 'Syne, sans-serif' }}>Our Professionals</h2>
