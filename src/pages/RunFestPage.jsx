...
const RunFestPage = () => {
  ...
  const styles = {
    ...
    bgNumber: { position: 'absolute', top: '45%', left: '50%', transform: 'translate(-50%, -50%)', fontFamily: '"Clash Display", sans-serif', fontWeight: 900, fontSize: isMobile ? '180px' : 'clamp(220px, 20vw, 320px)', opacity: 0.6, zIndex: 0, pointerEvents: 'none' },
